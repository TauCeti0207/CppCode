 ...
 * @LastEditTime: 2025-06-03 20:49:51
 */
#include <iostream>
#include <cassert>
#include <vector>
...
void test_list14()
{
	...
	lt.push_back(4);
	lt.push_back(5);
	yzq::list<int>::reverse_iterator rit = lt.rbegin();
	while (rit != lt.rend())
	{
		std::cout << *rit << " ";
		++rit;
...
void test_func(const yzq::list<int> &lt)
{
	yzq::list<int>::const_reverse_iterator rit = lt.rbegin();
	while (rit != lt.rend())
	{
		// *it = 1; // err
		std::cout << *rit << " ";
